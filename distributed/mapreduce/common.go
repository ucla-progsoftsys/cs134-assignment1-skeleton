...
// common.go contains definitions of data structures and functions that are common across multiple files
// You may modify this file if you would like, but it is not necessary. 
